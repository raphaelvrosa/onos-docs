var versions = [
  {path: "", text: "latest", selected: true },
  {path: "v0.1-onfconnect", text: "v0.1-onfconnect", selected: false },
  {path: "v0.6.0", text: "v0.6.0", selected: false },
];
...
function addMaterialMenu(elt, versions) {
  ...
  rootLi.classList.add('version_chooser');
